        ...
        <div id="light-box-container" class="light-box-solo box-container">
            <div class="container center-align">
                ...
                <div id="mapa-solo-box" class="row div-mapas">
                    ...
                    <div id="mapa-solo-default-box" class="col m11 offset-m1 right-align div-mapas-texturas-box">
                        <img id="zoom-mapa-default-img"  src="img/mapa-solo.png" class="responsive-img" data-zoom-image="img/mapa-grande-completo.png"/>
                    </div>

                    <div id="mapa-solo-azul-box" class="col m11 offset-m1 right-align div-mapas-texturas-box">
                        <img id="zoom-mapa-azul-img" src="img/mapa-azul-solo.png" class="responsive-img" data-zoom-image="img/mapa-grande-azul.png"/>
                    </div>
                    <div id="mapa-solo-laranja-box" class="col m11 offset-m1 right-align div-mapas-texturas-box">
                        <img id="zoom-mapa-laranja-img" src="img/mapa-laranja-solo.png" class="responsive-img" data-zoom-image="img/mapa-grande-laranja.png"/>
                    </div>
                    <div id="mapa-solo-amarelo-box" class="col m11 offset-m1 right-align div-mapas-texturas-box">
                        <img id="zoom-mapa-amarelo-img" src="img/mapa-amarelo-solo.png" class="responsive-img" data-zoom-image="img/mapa-grande-amarelo.png"/>
                    </div>  
                    <div id="mapa-solo-vermelho-box" class="col m11 offset-m1 right-align div-mapas-texturas-box">
                        <img id="zoom-mapa-vermelho-img" src="img/mapa-vermelho-solo.png" class="responsive-img" data-zoom-image="img/mapa-grande-vermelho.png"/>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="light-box-container" class="light-box-hidro box-container">
            ...
            <div class="container center-align">
                ...
                <div id="mapa-hidro-default-box" class="col s12">
                    <img id="zoom-hidro-img" src="img/mapa-hidrografico-pequeno.png" class="responsive-img" data-zoom-image="img/mapa-hidrogafico-grande.jpg"/>
                </div>
            </div>
        </div>
            ...
            <div class="container center-align container-default">
                <nav class="transparent menu-mapas " role="navigation">
                    <div class="nav-wrapper container centralizar-filho">
                        <ul>
                            <li><a href="#" class="mapas-show" rel="localizacao">LOCALIZACAO</a></li>
                            <li><a href="#" class="mapas-show" rel="solo">SOLO</a></li>
                            <li><a href="#" class="mapas-show" rel="hidro">HIDROGRAFIA</a></li>
                            <li><a href="#" class="mapas-show" rel="galeria">GALERIA</a></li>
                        </ul>
                ...
                <div id="mapa-solo" class="row div-mapas">
                    ...
                    <div id="texturas-solo">
                        <div id="textura-azul" class="col s3 center-align">
                            <img src="img/azul.png" class="show-img-textura" rel="azul"/>
                            <p>Textura acima de 30% <br>5,748.3 ha </p>
                        </div>
                        <div id="textura-laranja" class="col s3">
                            <img src="img/laranja.png" class="show-img-textura" rel="laranja"/>
                            <p>Textura entre 20 e 30% <br>1,813.8 ha </p>
                        </div>
                        <div id="textura-amarelo" class="col s3">
                            <img src="img/amarelo.png" class="show-img-textura" rel="amarelo"/>
                            <p>Textura entre 15 e 20% <br>4,896.6 ha </p>
                        </div>
                        <div id="textura-vermelho" class="col s3">
                            <img src="img/vermelho.png" class="show-img-textura" rel="vermelho"/>
                            <p>Textura abaixo de 15% <br>6,339.9 ha </p>
                        </div>
                    </div>
                ...
                <div id="mapa-galeria" class="row div-mapas">
                    <div class="row">
                        <div id="demo-test-gallery" class="demo-gallery">
                            ...
                            <a href="https://farm4.staticflickr.com/3902/14985871946_24f47d4b53_h.jpg" data-size="1600x1067" data-med="https://farm4.staticflickr.com/3902/14985871946_86abb8c56f_b.jpg" data-med-size="1024x683" >
                                <img src="https://farm4.staticflickr.com/3902/14985871946_86abb8c56f_m.jpg" alt="" />
                            </a>

                            <a href="https://farm6.staticflickr.com/5584/14985868676_b51baa4071_h.jpg" data-size="1600x1067" data-med="https://farm6.staticflickr.com/5584/14985868676_4b802b932a_b.jpg" data-med-size="1024x683" >
                                <img src="https://farm6.staticflickr.com/5584/14985868676_4b802b932a_m.jpg" alt="" />
                            </a>

                            <a href="https://farm4.staticflickr.com/3920/15008465772_d50c8f0531_h.jpg" data-size="1600x1067" data-med="https://farm4.staticflickr.com/3920/15008465772_383e697089_b.jpg" data-med-size="1024x683" >
