            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col s12 m6 left">
                        <img src="img/andre.png" width="450" height="300" class="responsive-img"/>
                    </div>                    
                </div>
            </div>
        </div>
        ...
        <div id="quemsomos-infos">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col s12 m6 right">
                        <img src="img/alfredo.png" width="450" height="300" class="responsive-img"/>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="quemsomos-infos">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col s12 m6 left">
                        <img src="img/joao.png" width="450" height="300" class="responsive-img"/>
                    </div>                    
                </div>
            </div>
        </div>
